...
local APP_HOST = os.getenv('APP_HOST') or 'app'
...
local instances = {
    ...
    ['storage_1_replica'] = {
        http_port = 8083,
        advertise_uri = 'localhost:13303',
    },
    ['storage_2_master'] = {
        http_port = 8084,
        advertise_uri = 'localhost:13304',
    },
    ['storage_2_replica'] = {
        http_port = 8085,
        advertise_uri = 'localhost:13305',
    },
}
...
for _, instance in pairs(instances) do
    instance.net_box = net_box.connect(
        ...
        { user = 'admin', password = 'secret', reconnect_after = 5, wait_connected = 10 }
    )
